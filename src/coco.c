...
void train_coco(char *cfgfile, char *weightfile)
{
    ...
    //char *train_images = "data/bags.train.darknet_list";
...
void validate_coco(char *cfgfile, char *weightfile)
{
    ...
    char *base = "results/";
    darknet_list *pdarknet_list = get_paths("data/coco_val_5k.darknet_list");
    //darknet_list *pdarknet_list = get_paths("/home/pjreddie/data/people-art/test.txt");
    //darknet_list *pdarknet_list = get_paths("/home/pjreddie/data/voc/test/2007_test.txt");
    char **paths = (char **)darknet_list_to_array(pdarknet_list);
